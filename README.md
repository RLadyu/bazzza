...
Одностраничное веб-приложение на `HTML + CSS + JavaScript` с рендерингом графа в `SVG` и клиническими цепочками «препарат → НЯ → контроль → обследование» с кратностью контроля.
